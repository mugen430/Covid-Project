...
input.addEventListener("input", function(){
    ...
    country_list.forEach( country => {
        country.name.toUpperCase().startsWith(value) ? document.getElementById(country.name).classList.remove('hide') : document.getElementById(country.name).classList.add('hide');
    })
})
